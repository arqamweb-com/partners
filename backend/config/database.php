...
return [
    ...
    */
    ...
    'connections' => [
        ...
        /*
         * قاعدة النسخة السابقة (PHP الخام) — للقراءة فقط أثناء الترحيل.
         * تُضبط في .env: LEGACY_DB_DATABASE و LEGACY_DB_USERNAME …
         */
        'legacy' => [
            'driver' => 'mysql',
            'host' => env('LEGACY_DB_HOST', env('DB_HOST', '127.0.0.1')),
            'port' => env('LEGACY_DB_PORT', env('DB_PORT', '3306')),
            'database' => env('LEGACY_DB_DATABASE', 'arqam_flow'),
